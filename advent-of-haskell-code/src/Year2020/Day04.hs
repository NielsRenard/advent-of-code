...
validHgt passport =
  ...
  in
    if unit == "cm" then atLeastAtMost 150 193 number else atLeastAtMost 59 76 number
...
invalidPassportsInput = [ "eyr:1972 cid:100",
...
validPassportsInput = [ "pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980",
                        "hcl:#623a2f",
                        "",
