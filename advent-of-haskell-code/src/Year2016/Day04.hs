  ...
  let allRooms = L.map parseString input
      decryptedRooms =
        L.map
          ...
          allRooms
   in L.filter (T.isInfixOf (T.pack "northpole object") . snd) decryptedRooms
...
-- parser of encrypted name aaaaa-bbb-z-y-x-
encryptedName :: ReadP String
encryptedName = munch isLetterOrDash

-- parser of sector id 123
sectorId :: ReadP Int
sectorId = fmap read . count 3 $ satisfy isDigit
